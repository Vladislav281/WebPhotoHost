...
namespace WebPhotoHostGeneral.Areas.Admin.Pages
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(AppDbContext db, IAdminRepository adminRepository)
        {
            _db = db;
        ...
        public IActionResult OnPost(string username, string password, User suser) //ÂÕÎÄ---------------
        {
            if (_adminRepository.Checkk(username, password) != null)//ìåòîä ïðîâåðêè check 
            {
                ...
                return RedirectToPage("/Wel", new { area = "Admin" });
