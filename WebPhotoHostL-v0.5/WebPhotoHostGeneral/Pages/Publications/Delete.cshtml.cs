...
namespace WebPhotoHostGeneral.Pages.Publications
{
    public class DeleteModel : PageModel
    {
        ...
        public DeleteModel(IPublicationRepository publicationRepository, IWebHostEnvironment webHostEnvironment)
        {
        ...
        //Реализация удаления публикации вместе с картинкой
